...
private:
	...
	util::AllocUniquePtr<Data> data_;
};
...
enum ConfigTableParamId {
	...
	CONFIG_TABLE_SYNC_MAX_PARALLEL_WORKER_SYNC_NUM,
	CONFIG_TABLE_SYNC_MAX_PARALLEL_NODE_SYNC_NUM,
	CONFIG_TABLE_SYNC_MAX_SYNC_HISTORY_NUM,
	...
	//CONFIG_TABLE_CS_REFRESH_STABLE_GOAL_INTERVAL,
	...
	CONFIG_TABLE_SYS_MONITORING_INTERVAL,
	CONFIG_TABLE_SYS_MONITORING_LIMIT,
	...
	CONFIG_TABLE_TXN_MONITORING_STORE_RATE,
	...
	CONFIG_TABLE_TRACE_RESOURCE_MONITOR,
	CONFIG_TABLE_TRACE_RESOURCE_MONITOR_PLAN,
...
enum StatTableParamId {
	...
	STAT_TABLE_PERF_TXN_TOTAL_EXPIRATION_CONTAINER_COUNT,
