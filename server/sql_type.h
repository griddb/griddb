...
struct SQLType {
	...
	enum Id {
		...
		EXPR_FUNCTION,
		EXPR_PLACEHOLDER,
		EXPR_LIMITED_PROJECTION,
		EXPR_SUB_LIMITED_PROJECTION,
		EXPR_LIST,
		EXPR_AGG_LIST,
		EXPR_WINDOW_COLUMN_LIST,
		EXPR_AGG_FOLLOWING,
		EXPR_AGG_ORDERING,
		EXPR_COND,
		EXPR_SCAN,
		EXPR_TUPLE_COLUMN,
		EXPR_CONTAINER_COLUMN,
		EXPR_COLLECTION_COLUMN,
		EXPR_TIME_SERIES_COLUMN,
		EXPR_META_COLUMN,
		EXPR_VIRTUAL_COLUMN,
		EXPR_FILTER_ID,
		EXPR_FILTER_ORDERED_ID,
		EXPR_HINT_NO_INDEX,
		EXPR_RANGE_GROUP,
		EXPR_RANGE_GROUP_ID,
		EXPR_RANGE_KEY,
