...
const util::NameCoderEntry<SQLType::Id> SQLType::Coder::ID_LIST[] = {
	...
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_OPTION),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_ANCHOR),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_CONCAT),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_VARIABLE),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_REPEAT),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_OR),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_VARIABLE_LIST),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_VARIABLE_DEF),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_PREV),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_NEXT),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_FIRST),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_LAST),
	UTIL_NAME_CODER_ENTRY(EXPR_PATTERN_CURRENT),
	...
	UTIL_NAME_CODER_ENTRY(FUNC_CLASSIFIER),
	UTIL_NAME_CODER_ENTRY(FUNC_MATCH_NUMBER),
	UTIL_NAME_CODER_ENTRY(FUNC_PREV),
	UTIL_NAME_CODER_ENTRY(FUNC_NEXT),
	UTIL_NAME_CODER_ENTRY(FUNC_FIRST),
	UTIL_NAME_CODER_ENTRY(FUNC_LAST),
