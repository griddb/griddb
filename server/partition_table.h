...
public:
	...
	*/
	...
	void filter(PartitionContext &context, util::Set<NodeId> &changedNodeSet,
		SubPartitionTable &subTable, bool isShortSync
		);
	...
	void createNextPartition(PartitionContext &context, uint32_t partitionNum);
