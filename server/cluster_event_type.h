...
enum GSEventType {
	...
	PRIORITY_JOB_BEGIN,
	PRIORITY_JOB_DEPLOY = CONTROL_JOB,
	PRIORITY_JOB_READY_OUTPUT = PRIORITY_JOB_BEGIN + 1,
	PRIORITY_JOB_PIPE,
	PRIORITY_JOB_FINISH,
	PRIORITY_JOB_CANCEL,
	...
	PRIORITY_JOB_VALIDATE_NODE,

	PRIORITY_JOB_EXECUTE,
	PRIORITY_JOB_CHECK_PERIODICALLY,
