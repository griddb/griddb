...
public:
	...
	void setExecuteRecoveryChecpoint(bool flag) {
		isExecuteRecoveryChecpoint_ = flag;
	}

	bool isExecuteRecoveryChecpoint() {
...
private:
	...
	bool isDump_;
	bool isSendReady_;
	bool isExecuteRecoveryChecpoint_;
