...
public class SubnetGridStoreFactoryProvider extends GridStoreFactoryProvider
	...
	public GridStoreFactory getFactory(
		...
		return new SubnetGridStoreFactory(chainProviderClasses);
	}
	...
	public Extensibles.AsStoreFactory getExtensibleFactory(
			Set<Class<?>> chainProviderClasses,
			Set<Class<?>> visitedProviderClasses) {
		return new SubnetGridStoreFactory.ExtensibleFactory(
